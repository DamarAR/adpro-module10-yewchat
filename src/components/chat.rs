    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen">
                // Sidebar
                <div class="flex-none w-56 h-screen bg-gradient-to-b from-blue-700 via-indigo-600 to-purple-700 text-white">
                ...
                // Main chat area
                <div class="grow h-screen flex flex-col bg-gradient-to-tr from-amber-50 via-orange-50 to-rose-50">
                    // Header
